const {guildMemberAdd, Discord, MessageEmbed} = require('discord.js')
...
exports.run = async (client, message, args) => {
    ...
    let kadınROL = Settings.kadınROL 
...
• <@&${Settings.kadınROL}> rollu verildi sunucumuzda **__Kadın__** olarak Kayıt edildi!
• 
`)
...
• İsim Yaş • **${isim} | ${yaş}**
• Verilen Roller • <@&${Settings.kadınROL}> 
